  ...
  nodes: {
    gate: {
      ...
      choices: [
        ...
        { kind: 'simple', label: 'Say nothing and turn to leave.', next: 'leave' },
      ],
    },
    truth: {
      id: 'truth',
      ...
      video: '',
      choices: [{ kind: 'simple', label: 'Thank him and enter.', next: 'enter' }],
    },
    persuaded: {
      id: 'persuaded',
      speaker: 'Gate Warden Aldric',
      ...
      video: '',
      choices: [{ kind: 'simple', label: 'Slip inside.', next: 'enter' }],
    },
    suspicious: {
      id: 'suspicious',
      speaker: 'Gate Warden Aldric',
      ...
      video: '',
      choices: [
        { kind: 'simple', label: 'Comply, then try the truth.', next: 'truth' },
        { kind: 'simple', label: 'Back off for now.', next: 'leave' },
      ],
    },
    bluffed: {
      id: 'bluffed',
      ...
      video: '',
      choices: [{ kind: 'simple', label: 'Walk through, heart pounding.', next: 'enter' }],
    },
    caught: {
      id: 'caught',
      speaker: 'Gate Warden Aldric',
      ...
      video: '',
      choices: [
        { kind: 'simple', label: 'Drop the act and tell the truth.', next: 'truth' },
        { kind: 'simple', label: 'Leave before this gets worse.', next: 'leave' },
      ],
    },
    enter: {
      id: 'enter',
